---
original_filename: www.xandeum.network_post_xandeum-alpha-release-wha_cf19577f.txt
source: https://www.xandeum.network/post/xandeum-alpha-release-what-to-expect
ingested_at: 2026-01-20
---

## Introduction to Xandeum Alpha Release
...
## Information for pNode Operators
...
1. Add storage rewards quickly.
2. Move to full bonding and staking for pNodes.
3. Reach out to customers for real-world use.
4. Launch beta with full Byzantine fault tolerance and no central components.
5. After beta, Xandeum will move to a stable, operational product.
